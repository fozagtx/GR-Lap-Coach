...
function parseTelemetryCSV(csvContent: string): TelemetryRow[] {
...
export function synthesizePerfectLapFromContent(csvContent: string): PerfectLapResult {
  const telemetryData = parseTelemetryCSV(csvContent);
